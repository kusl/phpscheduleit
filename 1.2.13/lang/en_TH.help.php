<?php
/**
* Thai (en_TH) help translation file.
* This also serves as the base translation file from which to derive
*  all other translations.
*  
* @author Nick Korbel <lqqkout13@users.sourceforge.net>
* @translator Varong B. <tewbc@hotmaill.com>
* @version 10-10-07
* @package Languages
*
...
?>
<div align="left"> 
  <h3><a name="top" id="top"></a>ระบบการจอง</h3>
<!-- <p><a href="http://phpscheduleit.sourceforge.net" target="_blank">http://phpscheduleit.sourceforge.net</a></p> -->
  <table width="100%" border="0" cellspacing="0" cellpadding="5" style="border: solid #CCCCCC 1px">
    <tr> 
      <td bgcolor="#FAFAFA"> 
      	<p align=left ><a href="#getting_started"><b>เริ่มต้นใช้งาน</b></a></p>
                  
            <a href="#registering">การสมัครสมาชิก</a>
            <a href="#logging_in">เข้าสู่ระบบ</a>
            <a href="#language">เลือกภาษาที่ใช้งาน</a>
            <a href="#manage_profile">การแก้ไขข้อมูลส่วนตัวและรหัสผ่าน</a>
            <a href="#resetting_password">เปลี่ยนรหัสผ่านเป็นค่าที่ใช้เริ่มต้น</a>
            <a href="#getting_support">ต้องการความช่วยเหลือ</a>
          
         <p align=left > <a href="#my_control_panel"><b>เมนูใช้งาน</b></a></p>
          
            <a href="#quick_links">เมนูลัดต่างๆ</a>
			<a href="#my_announcements">การแจ้งประกาศ</a>
            <a href="#my_reservations">การจอง</a>
            <a href="#my_training">การอนุมัติการจอง</a>
			<a href="#my_invitations">การจองใช้งานร่วมกัน</a>
			<a href="#my_participation">การจองที่เคยเข้าร่วมมา</a>         
          
          <p align=left ><a href="#using_the_scheduler"><b>การใช้งานตารางการจอง</b></a></p>
          
			<a href="#read_only">ดูได้อย่างเดียว</a>
            <a href="#making_a_reservation">การทำรายการจอง</a>
            <a href="#modifying_deleting_a_reservation">การแก้ไขและลบรายกาจองรที่ทำไว้</a>
            <a href="#navigating">การใช้งานปุ่มต่างๆ</a>
