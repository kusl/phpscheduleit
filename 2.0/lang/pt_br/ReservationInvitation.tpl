...
{include file='..\..\tpl\Email\emailheader.tpl'}
	...
	{if count($RepeatDates) gt 0}
		<br/>
		As repetições de reserva nas seguintes datas:
		<br/>
	{/if}
	...
	{if $RequiresApproval}
		<br/>
		Um ou mais dos recursos reservados requerem aprovação antes do uso. Esta reserva será pendente até que seja aprovado.
	{/if}
