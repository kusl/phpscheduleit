...
{include file='..\..\tpl\Email\emailheader.tpl'}
	...
	{if count($RepeatDates) gt 0}
		<br/>
		A reserva foi repetida nas seguintes datas:
		<br/>
	{/if}
	...
	{if $RequiresApproval}
		<br/>
		Um ou mais dos recursos reservados requerem aprovação antes do uso. Certifique-se que este pedido de reserva seja aprovado ou rejeitado.
	{/if}
