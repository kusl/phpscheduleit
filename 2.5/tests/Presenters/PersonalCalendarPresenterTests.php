...
class PersonalCalendarPresenterTests extends TestBase
{
	...
	public function setup()
	{
		...
		$this->presenter = new PersonalCalendarPresenter($this->page, $this->repository, $this->calendarFactory, $this->subscriptionService, $this->userRepository, $this->resourceService, $this->scheduleRepository);
	}
	...
	public function testBindsEmptyCalendarToPageWhenNoReservationsAreFound()
	{
		...
		$this->repository->expects($this->once())
						 ...
						 ->with($this->equalTo($month->FirstDay()), $this->equalTo($month->LastDay()),
