...
// @since 1.1.0
$strings['This system requires that you have an email address.'] = 'Pour ce système il est impératif que vous possédiez une adresse de courrier électronique';
$strings['Invalid User Name/Password.'] = 'Nom d\'utilisateur ou mot de passe invalide.';
$strings['Pending User Reservations'] = 'Reservations en cours pour l\' utilisateur';
$strings['Approve'] = 'Confirme';
$strings['Approve this reservation'] = 'Confirmez cette réservation';
$strings['Approve Reservations'] ='Confirme réservation';

$strings['Announcement'] = 'Annonce';
$strings['Number'] = 'Nombre';
$strings['Add Announcement'] = 'Ajoute une Annonce';
$strings['Edit Announcement'] = 'modifie une Annonce';
$strings['All Announcements'] = 'Toutes les Annonce';
$strings['Delete Announcements'] = 'Supprime une Annonce';
$strings['Use start date/time?'] = 'Utilise date/heure de début ?';
$strings['Use end date/time?'] = 'Utilise date/heure de fin?';
...
$strings['Pending Approval'] = 'Confirmation en cours';
$strings['My reservation is approved'] = 'Ma réservation est confirmée';
$strings['This reservation must be approved by the administrator.'] = 'Cette réservation doit être confirmée par l\'administrateur.';
$strings['Approval Required'] = 'Confirmation nécessaire';
$strings['No reservations requiring approval'] = 'Aucune réservation ne nécessite de confirmation.';
$strings['Your reservation was successfully approved'] = 'Votre réservation a été confirmée.';
$strings['Reservation approved for'] = 'Reservation confirmée pour %s';
$strings['approved'] = 'confirmée';
$strings['Reservation approved'] = 'Reservation confirmée';
...
$strings['Invite Users'] = 'Invite des utilisateurs';
$strings['Remove Participants'] = 'Retire des participants';
$strings['Reservation Invitation'] = 'Invitation à réserver';
$strings['Manage Invites'] = 'Gère les invites';
$strings['No invite was selected'] = 'Aucun invités n\'a été sélectionné';
$strings['reservation accepted'] = '%s a accepter votre invitation le %s';
$strings['reservation declined'] = '%s a décliner votre invitation le %s';
$strings['Login to manage all of your invitiations'] = 'Connexion pour gérer toutes vos invitaitons';
...
$strings['Accept'] = 'Accepte';
$strings['Decline'] = 'Décline';
$strings['Accept or decline this reservation'] = 'Accepte ou décline cette réservation';
...
$strings['View Resource Calendar'] = 'Vue du calendrier de la planification des resources ';
$strings['Signup View'] = 'Vue de connexion';

$strings['Select User'] = 'Choisir un utilisateur';
$strings['Change'] = 'Modification';

$strings['Update'] = 'Modification';
...
$email['register'] = "%s, %s \r\n"
				...
				. "%s \r\n\r\n"
				. "Vous trouverez des liens hypertexte au planificateur en ligne et pour mettre à jour votre profil à Mon Panneau de Contrôle.\r\n\r\n"
				. "Merci d\'adresser toute question concernant les ressources ou les réservations à %s";
...
$email['reservation_activity_1'] = "%s,\r\n<br />"
			. "Vous avez %s la reservation #%s avec succès.\r\n\r\n<br/><br/>"
