...
$strings['Bookings'] = '預約';											// @since 1.2.0
$strings['Change My Profile Information/Password'] = '變更個人資料';		// @since 1.2.0
$strings['Manage My Email Preferences'] = '電子郵件偏好';				// @since 1.2.0
$strings['Mass Email Users'] = '大量電郵使用者';
$strings['Search Scheduled Resource Usage'] = '搜尋預約';		// @since 1.2.0
...
// @since 1.2.0
$strings['Maximum Participant Capacity'] = '最多可參與人數';
$strings['Leave blank for unlimited'] = '留空表示不設限';
$strings['Maximum of participants'] = '這個資源的最大可參與人數為 %s 人';
$strings['That reservation is at full capacity.'] = '這個預約已經額滿了.';
$strings['Allow registered users to join?'] = '是否允許註冊的使用者參加?';
$strings['Allow non-registered users to join?'] = '是否允許未註冊的使用者參加?';
$strings['Join'] = '參加';
$strings['My Participation Options'] = '我的參與選項';
$strings['Join Reservation'] = '參加預約';
$strings['Join All Recurring'] = '參加所有循環的預約';
$strings['You are not participating on the following reservation dates because they are at full capacity.'] = '因為已經額滿, 您無法參加下列日期的預約.';
$strings['You are already invited to this reservation. Please follow participation instructions previously sent to your email.'] = '您已經被邀請參加這個預約. 請跟隨給您的電子郵件的指示參加這個預約.';
$strings['Additional Tools'] = '額外的工具';
$strings['Create User'] = '建立使用者';
$strings['Check Availability'] = '檢查是否可用';
$strings['Manage Additional Resources'] = '管理額外的資源';
$strings['All Additional Resources'] = '所有額外的資源';
$strings['Number Available'] = '可用的數量';
$strings['Unlimited'] = '無限制';
$strings['Add Additional Resource'] = '增加額外的資源';
$strings['Edit Additional Resource'] = '編輯額外的資源';
$strings['Checking'] = '檢查中';
$strings['You did not select anything to delete.'] = '您沒有選擇要刪除的東西.';
$strings['Added Resources'] = '增加的資源';
$strings['Additional resource is reserved'] = '額外的資源 %s 每次只有 %s 個可用';
...
$strings['Reminder Subject'] = '預約提醒- %s, %s %s';
$strings['Reminder'] = '提醒';
$strings['before reservation'] = '預約前';
$strings['My Participation'] = '我的參與';
$strings['My Past Participation'] = '我過去的參與';
$strings['Timezone'] = '時區';
$strings['Export'] = '匯出';
$strings['Select reservations to export'] = '選擇要匯出的預約';
$strings['Export Format'] = '匯出格式';
$strings['This resource cannot be reserved less than x hours in advance'] = '這個資源不能在少於 %s 小時前預約';
$strings['This resource cannot be reserved more than x hours in advance'] = '這個資源不能在多於 %s 小時前預約';
$strings['Minimum Booking Notice'] = '最小預約通知';
$strings['Maximum Booking Notice'] = '最大預約通知';
$strings['hours prior to the start time'] = '開始前...小時';
$strings['hours from the current time'] = '從現在起...小時';
$strings['Contains'] = '包含';
$strings['Begins with'] = '開始為';
$strings['Minimum booking notice is required.'] = '最小預約通知是必需的.';
$strings['Maximum booking notice is required.'] = '最大預約通知是必需的.';
$strings['Manage Additional Resources'] = '管理附件';
$strings['Add Additional Resource'] = '增加附件';
$strings['Edit Additional Resource'] = '編輯附件';
$strings['Accessory Name'] = '附件名稱';
...
$email['Reminder Body'] = "您的 %s 預約, 從 %s %s 到 %s %s 已經接近了.";
?>